<div>
  <h1 align="center"><a href="https://go.mikecodeur.com/react-mastery">React Patterns 🚀 ReactMastery.Dev</a></h1>
  <strong>
    Les patterns les plus courants avec React
  </strong>
  <p>
    Module de la formation React Mastery. Module sur les patterns les plus courants en React. Proxy Component, Props function, HOC, Props Drilling, State hoisting, Lifting State up
  </p>

  <a href="https://go.mikecodeur.com/react-mastery">
    <img 
      alt="Apprendre React"
      src="https://mikecodeur.com/mike/assets/courses/react-mastery-4.png"
    />
  </a>
...
```
git clone https://github.com/MikeCodeur/react-patterns.git
cd react-patterns
npm run init
```
...
<table>
  <tr>
    <td align="center"><a href="https://mikecodeur.com"><img src="https://avatars.githubusercontent.com/u/595162?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Mike Codeur</b></sub></a><br /><a href="https://github.com/mikecodeur/react-patterns/commits?author=mikecodeur" title="Code">💻</a> <a href="https://github.com/mikecodeur/react-patterns/commits?author=mikecodeur" title="Documentation">📖</a> <a href="#infra-mikecodeur" title="Infrastructure (Hosting, Build-Tools, etc)">🚇</a> <a href="https://github.com/mikecodeur/react-patterns/commits?author=mikecodeur" title="Tests">⚠️</a></td>
  </tr>
...
[build-badge]: https://img.shields.io/github/workflow/status/MikeCodeur/react-patterns/installation
[build]: https://github.com/MikeCodeur/react-patterns/actions
...
[license]: https://github.com/mikecodeur/react-patterns/blob/main/LICENSE
...
[issue]: https://github.com/mikecodeur/react-patterns/issues/new
<!-- prettier-ignore-end -->
